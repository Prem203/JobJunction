...
export const API_KEY = "af976c48a2mshbdafd020f9b0dd1p15a9cajsnab676470f889";
export const API_HOST = "jsearch.p.rapidapi.com";

export const QUERY_WEB_DEVELOPMENT_JOBS = "Web Development";
export const QUERY_PYTHON_DEVELOPMENT_JOBS = "Python developer";
export const QUERY_COMPUTER_NETWORKING_JOBS = "Computer Networking";
export const QUERY_MOBILE_APP_DEVELOPMENT_JOBS = "Mobile App Developer";
export const QUERY_DATA_SCIENCE_JOBS = "Data Science";
export const QUERY_UI_UX_DESIGN_JOBS = "UI/UX Design";
export const QUERY_SOFTWARE_DEVELOPMENT_JOBS = "Software Developer";
export const QUERY_SOFTWARE_ENGINEERING_JOBS = "Software Engineering";

export const FETCH_WEB_DEVELOPMENT_JOBS_URL =
  "https://jsearch.p.rapidapi.com/search?query=Web%20Development&page=1&num_pages=10";
export const FETCH_PYTHON_DEVELOPMENT_JOBS_URL =
...
export const FETCH_UI_UX_DESIGN_JOBS_URL =
  "https://jsearch.p.rapidapi.com/search?query=UI%2FUX%20Design&page=1&num_pages=10";
export const FETCH_SOFTWARE_DEVELOPMENT_JOBS_URL =
